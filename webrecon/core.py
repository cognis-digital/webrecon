"""WEBRECON core — Fingerprint web tech/CMS/frameworks from headers + body."""
...
RULES = [
    ("WEB-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("WEB-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("WEB-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
