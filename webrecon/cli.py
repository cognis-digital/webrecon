...
import argparse, sys
from webrecon.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="webrecon", description="WEBRECON — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from webrecon.mcp_server import serve
        return serve()
    if args.cmd == "scan":
