"""Native cognis-connect emit for webrecon — forward findings to any platform.

Maps webrecon's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    webrecon ... --format json | webrecon-emit --to stix
    webrecon-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
