#!/usr/bin/env sh
# Universal installer for webrecon. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/webrecon.git"
echo "Installing webrecon ..."
