...
[![PyPI](https://img.shields.io/pypi/v/cognis-webrecon.svg)](https://pypi.org/project/cognis-webrecon/)
[![CI](https://github.com/cognis-digital/webrecon/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/webrecon/actions)
...
WEBRECON exists for one job — fingerprint web tech/cms/frameworks from headers + body — and does it without a SaaS bill or heavyweight setup.
...
```bash
webrecon --version
webrecon scan .                      # scan the current project
webrecon scan . --format json
webrecon scan . --fail-on high       # non-zero exit for CI gates
webrecon mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **whatweb/wappalyzer**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`webrecon` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
